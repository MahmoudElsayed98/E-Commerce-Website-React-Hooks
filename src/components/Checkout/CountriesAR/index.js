...
function CountriesAR() {
  return (
    <>
      <option value="">اختر البلد</option>
      <option value="Afghanistan">أفغانستان</option>
      <option value="Åland Islands">جزر آلاند</option>
      ...
      <option value="French Southern and Antarctic Lands">
        الأراضي الفرنسية الجنوبية وأنتاركتيكا
      </option>
      ...
      <option value="Macedonia, Republic of">جمهورية مقدونيا</option>
      ...
      <option value="Sint Maarten (Dutch part)">سينت مارتن</option>
